                      ...
                      <div className="cart-table-prd-content-wrap">
                        <div className="cart-table-prd-info">
                          <div className="cart-table-prd-price">
                            ...
                            <div className="price-new">₹ {ele.subVariation.price - ele.subVariation.price / 10}</div>
                          </div>
                        ...
                        <div className="cart-table-prd-qty">
                          <div className="qty qty-changer">
                            ...
                            <input type="text" className="qty-input" defaultValue={ele.cart_quantity} data-min={0} data-max={100} />
                            <button className="increase" />
                          </div>
                        </div>
                        <div className="cart-table-prd-price-total">
                          ₹ {ele.subVariation.price * ele.cart_quantity}
                        </div>
                      </div>
            ...
            <div className="col-lg-7 col-xl-5 mt-3 mt-md-0">
              <div className="card-total">
                <div className="row d-flex">
                  ...
                  <div className="col-auto card-total-price text-right">$ 475.00</div>
                </div>
